function Check_WeaponCards(filename)
    ...
    --//////////////////////////////////////////////////////////////////    
    	["w/1.png"] = function()
    			...
    			set_stats(card_info, 12,1,5,5,1,0,0,10,"weapon",1,1)
    	...
    	["w/2.png"] = function()
    			...
    			set_stats(card_info, 11,1,4,4,2,0,0,12,"weapon",1,1)
    			card_info.actions[table.getn(card_info.actions) + 1] = set_action("health", "", -3, 1)
    		end,
     	["w/3.png"] = function()
    			card_info.name = "stab"
    			set_stats(card_info, 12,1,4,4,1,0,0,12,"weapon",1,1)
                card_info.actions[table.getn(card_info.actions) + 1] = set_action("health", "", -3, 1)
    		end,
        ["w/4.png"] = function()
                card_info.name = "morningstar"
                set_stats(card_info, 11,3,4,4,1,0,0,7,"weapon",1,1)
        ...
        ["w/5.png"] = function()
                ...
                set_stats(card_info, 2,12,4,4,0,1,0,12,"weapon",1,1)
                card_info.actions[table.getn(card_info.actions) + 1] = set_action("health", "", -3, 1)
            end,
        ["w/6.png"] = function()
        ...
        ["w/12.png"] = function()
                ...
                set_stats(card_info, 7,7,7,7,2,0,0,7,"weapon",1,2.5)
