function Check_FocusCards(filename)
    ...
    --//////////////////////////////////////////////////////////////////    
        ...
        ["f/3.png"] = function()
                ...
                set_stats(card_info, 4,6,1,1,0,2,0,0,"focus",3,1)
                card_info.actions[table.getn(card_info.actions) + 1] = set_action("health", "", 10, 0)
                card_info.actions[table.getn(card_info.actions) + 1] = set_action("draw", "", 1, 0)
                card_info.actions[table.getn(card_info.actions) + 1] = set_action("play", "", 1, 0)
            end,
        ...
        ["f/6.png"] = function()
                ...
                set_stats(card_info, 6,6,3,3,0,0,0,0,"focus",3,1)
        ...
        ["f/7.png"] = function()
                ...
                set_stats(card_info, -1,-1,-1,-1,0,0,1,0,"focus",3,1.5)
        ...
        ["f/14.png"] = function()
                ...
                set_stats(card_info, 9,9,9,9,0,1,6,"focus",3,3)
