function Check_SpeedCards(filename)
    ...
    --//////////////////////////////////////////////////////////////////    
        ...
        ["s/2.png"] = function()
                card_info.name = "dash"
                set_stats(card_info, 2,2,-1,-1,0,2,0,0,"speed",4,1)
        ...
        ["s/5.png"] = function()
                card_info.name = "trip"
                set_stats(card_info, 3,3,3,3,0,0,1,0,"speed",4,1)
        ...
        ["s/11.png"] = function()
                ...
                set_stats(card_info, 1,11,1,1,0,1,0,0,"speed",4,2)
        ...
        ["s/12.png"] = function()
                card_info.name = "stun"
                set_stats(card_info, 6,0,0,0,0,0,1,6,"speed",4,2.5)
                card_info.actions[table.getn(card_info.actions) + 1] = set_action("end_round", "", 0, 0)
                card_info.actions[table.getn(card_info.actions) + 1] = set_action("discard_next_round", "", 1, 1)
            end,
        ["s/13.png"] = function()
                card_info.name = "disarm"
                set_stats(card_info, 13,2,2,2,2,0,0,19,"speed",4,3)
                card_info.actions[table.getn(card_info.actions) + 1] = set_action("steal", "", 1, 1)
                card_info.actions[table.getn(card_info.actions) + 1] = set_action("discard", "", 1, 1)
                end,                                
        ["s/14.png"] = function()
                card_info.name = "opportunity-attack"
                set_stats(card_info, 13,7,0,0,0,0,1,21,"speed",4,3)
        ...
        ["s/15.png"] = function()
                ...
                set_stats(card_info, -1,-1,-1,-1,0,0,0,5,"speed",4,3)
