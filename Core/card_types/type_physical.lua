function Check_PhysicalCards(filename)
    ...
    --//////////////////////////////////////////////////////////////////    
        ...
        ["p/5.png"] = function()
                ...
                set_stats(card_info, 3,3,1,4,1,0,0,6,"physical",2,1)
                card_info.actions[table.getn(card_info.actions) + 1] = set_action("armour", "", -10, 1)
                card_info.actions[table.getn(card_info.actions) + 1] = set_action("discard", "", 1, 1)
            end,
        ["p/6.png"] = function()
                card_info.name = "bear_hug"
                set_stats(card_info, 3,3,1,4,2,0,0,4,"physical",2,1)
                card_info.actions[table.getn(card_info.actions) + 1] = set_action("health", "", -3, 1)
                card_info.actions[table.getn(card_info.actions) + 1] = set_action("block", "", 4, 1) --speed
        ...
        ["p/7.png"] = function()
                card_info.name = "dive"
                set_stats(card_info, 3,3,1,4,0,1,0,2,"physical",2,1.5)
        ...
        ["p/8.png"] = function()
                ...
                set_stats(card_info, 3,1,3,1,2,0,0,9,"physical",2,2)
                card_info.actions[table.getn(card_info.actions) + 1] = set_action("health", "", -6, 1)
                card_info.actions[table.getn(card_info.actions) + 1] = set_action("discard", "", 1, 1)
            end, 
        ["p/9.png"] = function()
                card_info.name = "double-kick"
                set_stats(card_info, 3,1,3,1,0,2,0,9,"physical",2,2)
                card_info.actions[table.getn(card_info.actions) + 1] = set_action("health", "", -6, 1)
                card_info.actions[table.getn(card_info.actions) + 1] = set_action("armour", "", -10, 1)
            end,
        ["p/10.png"] = function()
                card_info.name = "bash"
                set_stats(card_info, 3,1,3,1,1,0,0,10,"physical",2,2)
        ...
        ["p/15.png"] = function()
                ...
                set_stats(card_info, 3,3,3,3,2,2,0,10,"physical",2,3.5)
