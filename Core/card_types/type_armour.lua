function Check_ArmourCards(filename)
    ...
    --//////////////////////////////////////////////////////////////////    
        ...
        ["a/2.png"] = function()
                ...
                set_stats(card_info, 8,8,5,5,0,0,1,0,"armour",5,1)
        ...
        ["a/3.png"] = function()
                ...
                set_stats(card_info, 7,7,6,6,0,2,0,0,"armour",5,1)
                card_info.actions[table.getn(card_info.actions) + 1] = set_action("health", "", -3, 1)
                card_info.actions[table.getn(card_info.actions) + 1] = set_action("armour", "", 5, 0)
                end,
        ["a/4.png"] = function()
                card_info.name = "staunch"
                set_stats(card_info, 7,7,5,5,0,0,0,0,"armour",5,1)
        ...
        ["a/5.png"] = function()
                ...
                set_stats(card_info, 7,7,4,4,0,0,0,0,"armour",5,1)
        ...
        ["a/6.png"] = function()
                ...
                set_stats(card_info, 9,9,6,6,0,0,1,0,"armour",5,1)
        ...
        ["a/8.png"] = function()
                ...
                set_stats(card_info, 12,12,9,9,0,0,0,1,"armour",5,2)
        ...
        ["a/10.png"] = function()
                ...
                set_stats(card_info, 11,11,8,8,0,2,0,5,"armour",5,2)
        ...
        ["a/11.png"] = function()
                ...
                set_stats(card_info, 6,6,6,6,0,0,0,3,"armour",5,2)
        ...
        ["a/13.png"] = function()
                ...
                set_stats(card_info, 12,12,10,10,0,2,0,6,"armour",5,3)
                card_info.actions[table.getn(card_info.actions) + 1] = set_action("health", "", -6, 1) 
                card_info.actions[table.getn(card_info.actions) + 1] = set_action("armour", "", 10, 0) 
            end,
        ["a/14.png"] = function()
                card_info.name = "forge"
                set_stats(card_info, 11,11,11,11,0,2,0,4,"armour",5,3)
